...
_path_sys.path.insert(0, str(_PathRoot(__file__).resolve().parents[2]))
...
if __package__:
    ...
    from 统一模型代码.common.reference_artifacts import ARTIFACTS, CORE_ARTIFACTS, verify_artifacts
    from 统一模型代码.common.runtime_paths import (
        OUTPUT_ROOT,
        REFERENCE_OUTPUT_ROOT,
        validate_output_path,
        validate_split_roots,
