...
from 统一模型代码.gates.g0 import e2e_g0 as g0  # noqa: E402
from 统一模型代码.gates.g0 import e2e_g0d as g0d  # noqa: E402
from 统一模型代码.gates.g0.directional_ladder import (  # noqa: E402
...
from 统一模型代码.common.runtime_paths import OUTPUT_ROOT, validate_output_path  # noqa: E402
...
def prepare(run_id: str) -> Path:
    ...
    files = [
        ...
        (Path(__file__).resolve().parents[3] / '统一模型代码/gates/g0/directional_ladder.py').resolve(),
        (Path(__file__).resolve().parents[3] / '统一模型代码/gates/g0/e2e_g0d.py').resolve(),
        (Path(__file__).resolve().parents[3] / '统一模型代码/physics/fine_dpd_autograd.py').resolve(),
    ]
