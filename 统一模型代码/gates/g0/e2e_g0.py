...
from 统一模型代码.gates.g0.gradient_audit import (  # noqa: E402
...
from 统一模型代码.common.reference_artifacts import verify_artifacts  # noqa: E402
...
def code_identity() -> dict[str, Any]:
    tracked = [
        ...
        PACKAGE_ROOT / "gates" / "g0" / "gradient_audit.py",
        PACKAGE_ROOT / "gates" / "g0" / "precision_gradient_audit.py",
...
def resource_and_system_gradient_report(
    ...
    if _uses_mixed_fp64_physics(args):
        from 统一模型代码.gates.g0.precision_gradient_audit import (
